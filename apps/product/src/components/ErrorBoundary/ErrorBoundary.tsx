...
import { AccessibleThemedText, AccessibleThemedButton } from '../../theme/components/AccessibleThemedComponents';
      ...
      >
        <View style={{ alignItems: 'center', maxWidth: 400 }}>
          ...
          <AccessibleThemedText
            ...
            isHeading
          >
            {level === 'app' ? 'App Crashed' : level === 'screen' ? 'Screen Error' : 'Component Error'}
          </AccessibleThemedText>
