...
import { useScreenTracking, useButtonTracking } from '../../hooks/useAnalytics';
      ...
      {privacyOptions.map((option) => (
        <TouchableOpacity
          ...
          style={{
            ...
            backgroundColor: privacyLevel === option.id ? `${theme.colors.primary}10` : theme.colors.surface,
          }}
        ...
        >
          <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: theme.sizes.spacingSM }}>
            <AccessibleThemedText 
              variant="primary" 
              size="md" 
              weight="semibold"
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.colors.background }}>
      ...
      >
        <AccessibleThemedView 
          variant="background"
          style={{ marginBottom: theme.sizes.spacingXL }}
        >
          <AccessibleThemedText 
            variant="primary" 
            size="3xl" 
        ...
        >
          ...
          <AccessibleThemedText variant="secondary" size="sm" style={{ marginBottom: theme.sizes.spacingSM }}>
