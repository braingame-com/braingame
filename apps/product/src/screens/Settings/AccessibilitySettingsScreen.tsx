...
const FontSizeSelector = withMemo(() => {
  ...
  const handleFontSizeChange = useCallback((value: FontSizeOption['value']) => {
  ...
  return (
    <View style={{ marginBottom: theme.sizes.spacingLG }}>
      ...
      <AccessibleThemedText
        variant="secondary"
        size="sm"
        style={{ marginTop: theme.sizes.spacingMD, fontSize: 16 * (fontSize === 'small' ? 0.85 : fontSize === 'large' ? 1.15 : fontSize === 'extra-large' ? 1.3 : 1) }}
      >
