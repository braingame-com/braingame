...
describe('Card', () => {
  ...
  it('renders with different orientations', () => {
    const { getByText } = render(
      <Card orientation="horizontal">Horizontal</Card>
    );
  ...
  it('applies test ID', () => {
    const { getByTestId } = render(
      <Card testID="test-card">Test</Card>
    );
  ...
  it('applies aria attributes', () => {
    const { getByLabelText } = render(
      <Card aria-label="Product card">Product</Card>
    );
