...
export const ProductCard: Story = {
	render: () => (
		<Card style={{ maxWidth: 300 }}>
			...
			<div style={{ fontSize: 24, fontWeight: "bold", color: "#007bff" }}>$99.99</div>
		</Card>
	),
};
	...
	render: () => (
		<Card orientation="horizontal" style={{ maxWidth: 400 }}>
			...
			<div style={{ flex: 1 }}>
				...
				<p style={{ margin: "0 0 8px 0", color: "#666" }}>Senior Developer</p>
				<p style={{ margin: 0, fontSize: 14, color: "#999" }}>john.doe@company.com</p>
			</div>
		</Card>
	),
};
