...
export const Text: React.FC<
	TextProps & { children?: React.ReactNode; testID?: string; style?: React.CSSProperties }
> = (props) => {
	const {
		children,
		variant = "body1",
	...
	const variantStyles =
		restyleTheme.textVariants[variantKey as keyof typeof restyleTheme.textVariants] ||
		restyleTheme.textVariants.body1;
	...
	return (
		<Component data-testid={testID} style={cleanStyles} {...rest}>
			{children}
		</Component>
	);
};