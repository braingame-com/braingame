...
describe('Avatar', () => {
  ...
  it('handles click events', () => {
    ...
    const { getByText } = render(
      <Avatar onClick={handleClick}>JD</Avatar>
    );
  ...
  it('renders with different variants', () => {
    ...
    variants.forEach(variant => {
      const { getByText } = render(
        <Avatar variant={variant}>V</Avatar>
      );
  ...
  it('applies test ID', () => {
    const { getByTestId } = render(
      <Avatar testID="test-avatar">Test</Avatar>
    );
  ...
  it('applies aria attributes', () => {
    const { getByLabelText } = render(
      <Avatar aria-label="User profile">UP</Avatar>
    );
  ...
  it('falls back to children when image fails', () => {
    const { getByText, container } = render(
      <Avatar src="invalid-url.jpg" alt="User">JD</Avatar>
    );
