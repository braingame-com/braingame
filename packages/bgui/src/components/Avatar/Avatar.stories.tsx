...
const meta = {
	...
	parameters: {
		docs: {
			description: {
				component:
					"Avatars are used to represent people or entities. They can display an image, initials, or an icon.",
			},
		},
	},
	argTypes: {
...
export const Clickable: Story = {
	render: () => (
		<div style={{ display: "flex", gap: 16, alignItems: "center" }}>
			...
			<Avatar onClick={() => alert("Another click!")} variant="outlined">
				AB
			</Avatar>
			<Avatar onClick={() => alert("Solid click!")} variant="solid">
				CD
			</Avatar>
		</div>
	),
...
export const WithImageFallback: Story = {
	render: () => (
		<div style={{ display: "flex", gap: 16, alignItems: "center" }}>
			<Avatar src="https://example.com/nonexistent.jpg" alt="User">
				JD
			</Avatar>
			<Avatar src="https://example.com/broken-image.jpg" alt="User" variant="outlined">
				AB
			</Avatar>
		</div>
	),
	...
	render: () => {
		const users = [
			...
			},
			{
				...
				initials: "JS",
				image:
					"https://images.unsplash.com/photo-1494790108755-2616b811b24c?w=150&h=150&fit=crop&crop=face",
			},
...
export const AvatarGroup: Story = {
	render: () => (
		<div style={{ display: "flex", alignItems: "center" }}>
			...
			<Avatar style={{ marginRight: -8, zIndex: 3 }} variant="outlined">
				AB
			</Avatar>
			<Avatar style={{ marginRight: -8, zIndex: 2 }} color="success">
				CD
			</Avatar>
			<Avatar style={{ zIndex: 1 }} color="warning">
				+3
			</Avatar>
		</div>
	),
