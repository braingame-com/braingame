...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: 'Container centers your content horizontally with responsive max-width constraints.',
      },
    },
  },
  argTypes: {
...
const DemoContent = () => (
  <div style={{ 
    ...
    <p>This content is wrapped in a Container component that provides responsive max-width and centering.</p>
  </div>
);
