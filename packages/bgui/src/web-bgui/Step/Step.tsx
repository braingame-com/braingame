...
import type { StepOwnerState, StepProps, StepTypeMap } from "./StepProps";
	...
	return {
		...
		[`.${stepperClasses.vertical} &`]: {
			...
			"&::after": {
				...
				height: "auto",
				margin:
					"calc(var(--Step-connectorInset) - var(--Step-gap)) auto calc(var(--Step-connectorInset) - var(--Stepper-verticalGap))",
				alignSelf: "stretch",
			},
		},
		variants: [
