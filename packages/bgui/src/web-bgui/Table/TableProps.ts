...
export type TablePropsSizeOverrides = {};
export type TablePropsColorOverrides = {};
export type TablePropsVariantOverrides = {};
export type TablePropsBorderAxisOverrides = {};
