...
import type { MergeDefault, OverridableImplicitRecord, OverridableRecord } from "./utils";
...
export type PaletteRangeOverrides = {};
...
export type PaletteCommonOverrides = {};
...
export type PaletteTextOverrides = {};
