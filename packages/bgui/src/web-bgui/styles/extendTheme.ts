...
import { createGetColorSchemeSelector, prepareTypographyVars } from "@mui/system/cssVars";
...
import type { SxProps, Theme, ThemeCssVar, ThemeScalesOptions, ThemeVars } from "./types";
import type {
	DefaultColorScheme,
	ExtendedColorScheme,
	SupportedColorScheme,
} from "./types/colorScheme";
import type { ColorPaletteProp, ColorSystem, Palette, PaletteOptions } from "./types/colorSystem";
import type { Focus } from "./types/focus";
import type { FontSize, TypographySystemOptions } from "./types/typography";
