...
export type ModalDialogPropsColorOverrides = {};
export type ModalDialogPropsVariantOverrides = {};
export type ModalDialogPropsSizeOverrides = {};
export type ModalDialogPropsLayoutOverrides = {};
