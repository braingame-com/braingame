...
import type { TextareaOwnerState, TextareaProps, TextareaTypeMap } from "./TextareaProps";
	...
	return [
		{
			...
			"&::before": {
				...
				boxShadow:
					"var(--Textarea-focusedInset, inset) 0 0 0 calc(var(--Textarea-focused) * var(--Textarea-focusedThickness)) var(--Textarea-focusedHighlight)",
			},
		} as const,
		{
			"&:hover": {
