...
import type { ApplyColorInversion, ColorPaletteProp, VariantProp } from "../styles/types";
...
export type DrawerPropsColorOverrides = {};
export type DrawerPropsSizeOverrides = {};
export type DrawerPropsVariantOverrides = {};
